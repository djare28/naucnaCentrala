...
public class ValidateRegistrationService implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        User user = identityService.newUser("guest1");
        ...
        Authority authority;
        if(korisnik.getRecenzent() == true) {
            authority = authorityRepository.findOneByName("ROLE_RECENZENT");
        } else {
            authority = authorityRepository.findOneByName("ROLE_USER");
        }
