...
@NoArgsConstructor
public class ChooseJournalSelection extends AbstractFormFieldType {

    public static final String TYPE_NAME = "casopis-select";
    protected Map<Long, String> values=new HashMap<>();

    public ChooseJournalSelection(Map<Long, String> values) {
        this.values = values;
    }
